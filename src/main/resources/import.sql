...
--
------password1
INSERT INTO user(user_id, enabled, email, full_name, username, password, account_non_expired, account_non_locked, credentials_non_expired) VALUES (999, 1, 'admin_email', 'admin_lastname', 'admin', '$2a$04$aAiATQxdXgbVhzF3Eujl1umIGVzZUTYN4m6phRLUQdu.M.1ZS/Sye', true, true, true)
